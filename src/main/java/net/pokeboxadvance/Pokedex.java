...
public class Pokedex {
  ...
  /**
   * Returns a Pokemon with a number matching the provided one. If no Pokemon with that number exists, the first one is returned. If the Pokedex is otherwise empty, null is returned.
   *
